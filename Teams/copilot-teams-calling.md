...
# Manage Microsoft 365 Copilot in Teams calls - Overview
...
Once someone starts transcription during a call, licensed users can select the Copilot button for use during and after the call.
