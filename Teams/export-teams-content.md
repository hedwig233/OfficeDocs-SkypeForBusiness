...
Learn more about the [Copilot Interactions Export API](/graph/api/aiinteractionhistory-getallenterpriseinteractions?view=graph-rest-1.0&preserve-view=true).
