...
| **Advanced Bookings and virtual appointments** |![Image of a checkmark for yes](/office/media/icons/success-teams.png) SMS notifications | ![Image of a checkmark for yes](/office/media/icons/success-teams.png) Queue views</br> *At the user level, these features apply to any user in the tenant who wants access to pre and post-appointment actions and data, like a meeting scheduler, supervisor, or admin.* | ![Image of a checkmark for yes](/office/media/icons/success-teams.png) Consumption and usage analytics for admins in the Teams admin center</br> |
