...
See [New-CsTeamsEmergencyCallRoutingPolicy](/powershell/module/teams/new-csteamsemergencycallroutingpolicy).
...
See [Set-CsTeamsEmergencyCallRoutingPolicy](/powershell/module/teams/set-csteamsemergencycallroutingpolicy).

## Assign a custom emergency call routing policy to users

[!INCLUDE [assign-policy](includes/assign-policy.md)]

See also [Grant-CsTeamsEmergencyCallRoutingPolicy](/powershell/module/teams/grant-csteamsemergencycallroutingpolicy).
...
Use the [Set-CsTenantNetworkSite](/powershell/module/teams/set-cstenantnetworksite) cmdlet to assign an emergency call routing policy to a network site.
