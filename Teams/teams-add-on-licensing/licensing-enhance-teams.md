...
- [Microsoft Teams Premium licensing](#microsoft-teams-premium-licensing)
  - [How does Teams Premium compare to Teams?](#how-does-teams-premium-compare-to-teams)
    ...
    - [Bookings and virtual appointments](#bookings-and-virtual-appointments)
    - [Meet app](#meet-app)
...
| Broadcast town halls to 50k attendees |  | ![Image of a checkmark for yes](/office/media/icons/success-teams.png) |
| Host up to 50 town halls simultaneously |  | ![Image of a checkmark for yes](/office/media/icons/success-teams.png) |
| Town hall Q&A capacity of 50k attendees |  | ![Image of a checkmark for yes](/office/media/icons/success-teams.png) |
...
- Bookings and virtual appointments: SMS notifications.
- Bookings and virtual appointments: Organizational analytics in the Teams admin center.
- Bookings and virtual appointments: Queue.
...
| **Advanced Bookings and virtual appointments** | ![Image of a checkmark for yes](/office/media/icons/success-teams.png) Custom lobby room with branding, logos, and more</br> ![Image of a checkmark for yes](/office/media/icons/success-teams.png) SMS notifications | ![Image of a checkmark for yes](/office/media/icons/success-teams.png) Queue views</br> *At the user level, these features apply to any user in the tenant who wants access to pre and post-appointment actions and data, like a meeting scheduler, supervisor, or admin.* | ![Image of a checkmark for yes](/office/media/icons/success-teams.png) Consumption and usage analytics for admins in the Teams admin center</br> |
