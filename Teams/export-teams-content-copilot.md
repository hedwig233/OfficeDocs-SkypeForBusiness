...
> [!NOTE]
> - Refer to [Teams Export APIs throttling limits](https://learn.microsoft.com/en-us/graph/throttling-limits) to understand Throttling limits for the COpilot Interactions Export API.
